...
namespace RocketBlog.Components
{
    public class Scheduler : SchedulerInterface
    {
        ...
        public override void DoWork()
        {
            ...
            {
                var portalCatalog = new PortalCatalogLimpet(portalId, DNNrocketUtils.GetCurrentCulture(), "rocketblog");
                ...
                {
                    if (portalCatalog.DebugMode) LogUtils.LogSystem("RocketBlog Scheduler not run, LastSchedulerTime: " + portalCatalog.LastSchedulerTime.ToString("O") + " CurrentTime: " + DateTime.Now.ToString("O"));
                }
            }
        }
    }
